class Component extends DCLogic {
  ...
  renderVals() {
    ...
    const projDefs = [
      { title: 'Spatial UI for a Car Booking Platform', desc: 'Designing an immersive spatial interface for seamless car booking experiences.', tags: 'Spatial UI · UX', color: '#3FA7D6', bg: '#EBF1FF', rot: -1.5, href: 'https://www.behance.net/gallery/252156661/Spatial-UI-for-a-Car-Booking-Platfrom', img: 'uploads/Spatial UI for a Car Booking Platfrom.jpeg' },
      { title: 'Fashion Clothing App Design', desc: 'A stylish mobile app experience for browsing & shopping fashion.', tags: 'UI · Mobile', color: '#FF6F61', bg: '#FFF3EB', rot: 1.5, href: 'https://www.behance.net/gallery/252092187/Fashion-Clothing-App-Design', img: 'uploads/Fabrikaa-Fashion App Prototype with Gamified User Experience.jpeg' },
      { title: 'AI Enhanced Customer Support Platform', desc: 'Streamlining customer support with AI-powered interactions & smart workflows.', tags: 'AI · UX · Web', color: '#8B6DFF', bg: '#EFEBFF', rot: -2, href: 'https://www.behance.net/gallery/246485079/AI-Enhanced-Customer-Support-Platform', img: '08fbd1e7-40a1-47da-969a-b00b1e7e6885' },
    ];
